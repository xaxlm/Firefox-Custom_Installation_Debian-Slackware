...
cd /
# Se descarga Firefox
wget https://download-installer.cdn.mozilla.net/pub/firefox/releases/57.0/linux-x86_64/es-MX/firefox-57.0.tar.bz2
cd /usr/local/
...
sleep 2
mv /firefox-57.0.tar.bz2 /usr/local/$DIRINST
tar jvxf firefox-57.0.tar.bz2
#
#App a Menú
...
echo -ne '\n'
rm -rf /usr/local/$DIRINST/firefox-57.0.tar.bz2
