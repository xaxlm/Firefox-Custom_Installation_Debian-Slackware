...
sleep 2
mv /firefox-76.0.tar.bz2 /usr/local/$DIRINST
tar jvxf firefox-76.0.tar.bz2
#
#App a Menú
cd /usr/share/applications/
touch firefox.desktop
echo '[Desktop Entry]' > firefox.desktop
echo 'Version=76.0' >> firefox.desktop
...
echo -ne '\n'
rm -rf /usr/local/$DIRINST/firefox-76.0.tar.bz2
