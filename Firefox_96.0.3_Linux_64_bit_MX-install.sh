...
cd /
# Se descarga Firefox
wget https://download-installer.cdn.mozilla.net/pub/firefox/releases/96.0.3/linux-x86_64/es-MX/firefox-96.0.3.tar.bz2
cd /usr/local/
...
sleep 2
mv /firefox-96.0.3.tar.bz2 /usr/local/$DIRINST
tar jvxf firefox-96.0.3.tar.bz2
#
#App a Menú
cd /usr/share/applications/
touch firefox.desktop
echo '[Desktop Entry]' > firefox.desktop
echo 'Version=96.0.3' >> firefox.desktop
...
echo 'Version=96.0.3' >> README.txt
...
echo -ne '\n'
rm -rf /usr/local/$DIRINST/firefox-96.0.3.tar.bz2
