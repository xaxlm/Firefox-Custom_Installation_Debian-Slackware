#!/bin/bash
# Última actualización: 15/12/2018
cd /
# Se descarga Firefox
wget https://download-installer.cdn.mozilla.net/pub/firefox/releases/64.0/linux-x86_64/es-MX/firefox-64.0.tar.bz2
cd /usr/local/
...
sleep 2
mv /firefox-64.0.tar.bz2 /usr/local/$DIRINST
tar jvxf firefox-64.0.tar.bz2
#
#App a Menú
cd /usr/share/applications/
touch firefox.desktop
echo '[Desktop Entry]' > firefox.desktop
echo 'Version=64.0' >> firefox.desktop
...
echo -ne '\n'
rm -rf /usr/local/$DIRINST/firefox-64.0 tar.bz2
