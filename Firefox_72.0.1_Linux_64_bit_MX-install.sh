#!/bin/bash
# Última actualización: 19/01/2020
cd /
# Se descarga Firefox
wget https://download-installer.cdn.mozilla.net/pub/firefox/releases/72.0.1/linux-x86_64/es-MX/firefox-72.0.1.tar.bz2
cd /usr/local/
...
sleep 2
mv /firefox-72.0.1.tar.bz2 /usr/local/$DIRINST
tar jvxf firefox-72.0.1.tar.bz2
#
#App a Menú
cd /usr/share/applications/
touch firefox.desktop
echo '[Desktop Entry]' > firefox.desktop
echo 'Version=72.0.1' >> firefox.desktop
...
echo 'Version=72.0.1' >> README.txt
...
echo -ne '\n'
rm -rf /usr/local/$DIRINST/firefox-72.0.1.tar.bz2
